...
void check_expiration() {
    ...
    if (remaining_time <= 0) {
        printf(RED "🔥 ===========================\n");
        printf("🔥 FILE CLOSED BY @TF_FLASH92 🔥\n");
        printf("🚀 DM TO BUY NEW FILE @TF_FLASH92 🚀\n");
        printf("🔥 ===========================\n" RESET);
        exit(EXIT_FAILURE);
    } else {
...
int main(int argc, char *argv[]) {
    ...
    if (strcmp(binary_name, "FLASHxBGMI") != 0) {
        printf(RED "\n🔥 ERROR: BINARY NAME MUST BE 'FLASHxBGMI' 🔥\n" RESET);
        exit(EXIT_FAILURE);
    }
    
if (argc != 5) {
    fprintf(stderr, RED "🔥═══════════════════════════════════════════🔥\n");
    fprintf(stderr, CYAN "🚀           LAND KE PAPA FLASH              🚀\n");
    fprintf(stderr, RED "🔥═══════════════════════════════════════════🔥\n" RESET);

    fprintf(stderr, "\n");
    fprintf(stderr, "┌────────────┬───────────────────────────────────────┐\n");
    fprintf(stderr, "│  papa ko  │  DM KARO :- @TF_FLASH92                        │\n");
    fprintf(stderr, "├────────────┼───────────────────────────────────────┤\n");
    ...
    fprintf(stderr, RED "🔥═══════════════════════════════════════════🔥\n");
    fprintf(stderr, GREEN "🔥 JOIN CHANNEL @FLASHxDILDOS1 🔥\n");
    fprintf(stderr, RED "🔥═══════════════════════════════════════════🔥\n" RESET);
    exit(EXIT_FAILURE);
}
    ip = argv[1];
