...
void print_stylish_text() {
    ...
    printf("\033[1;35m╠════════════════════════════════════════╣\033[0m\n");
    printf("\033[1;35m║ \033[1;33m✦ DEVELOPED BY: \033[1;32m@TF_FLASH92 \033[1;35m║\033[0m\n");
    ...
    printf("\033[1;35m║ \033[1;33m✦ CONTACT: \033[1;32m@TF_FLASH92 \033[1;35m║\033[0m\n");
    printf("\033[1;35m╠════════════════════════════════════════╣\033[0m\n");
...
int main(int argc, char *argv[]) {
    ...
    if (local->tm_year + 1900 > EXPIRATION_YEAR ||
        ...
        printf("\033[1;31mExpired. khatam ho gya h developar se connect kr @TF_FLASH92.\033[0m\n");
        return EXIT_FAILURE;
    }
